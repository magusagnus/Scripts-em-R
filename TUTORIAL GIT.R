...
####PARA INTEGRAR A VERSÃO LOCAL DE UM NOVO PROJETO COM O GIT HUB###

#NO GIT HUB CLIQUE EM  "new repository"
# PREENCHA OS DADOS, DEFINA OS ACESSOS (PUBLICO OU PRIVADO) E CRIE O REPOSITORIO

#DEPOIS DE CRIADO O REPOSITORIO, VÁ EM "your repositories"
...
#     git commit -m "ESCREVA AQUI A  DESCRIÇÃO DO COMMIT"

#PARA ENVIAR OS ARQUIVOS PARA A VERSÃO REMOTA (QUE ? O GIT HUB)
